...
export const verticalMenuItems = [ 
    new Menu (1, 'Message Log', '/messageLog', null, 'messageLog', null, false, 0),
     /*new Menu (2, 'Dashboard', '/', null, 'dashboard', null, false, 0),
    new Menu (3, 'Task Filters', '/task-filters', null, 'dvr', null, false, 0),
